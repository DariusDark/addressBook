...
function Contact() {
    ...
    return (
        <div className="current-contact">
            <form className="current-contact__form" onSubmit={(event) => {
                ...
                {contact.isEditActive ?
                    <div className="current-contact__btn-container">
                        ...
                        <button className="btn btn-cancel" type="button" onClick={() => { dispatch(editable(0)) }}>Cancel</button>
                    </div> :
                    null
                }
            </form>
            ...
            <button className="btn btn-edit" onClick={() => { dispatch(editable(true)) }}>Edit</button>
